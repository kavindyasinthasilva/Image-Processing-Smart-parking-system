    ...
    public partial class MainForm : Form
    {
        ...
        private void capCameraBtn_Click(object sender, EventArgs e)
        {
            if (capture != null)
            {
                ...
                Console.WriteLine(text_PlateIn.Text);
        ...
        private void pictureBox_CarIn_Click(object sender, EventArgs e)
        {
        ...
        private void CheckIn_Click(object sender, EventArgs e)
        {
            ...
            String temp3 = label2.Text;

            SmartParking.ChechkVlues sky = new SmartParking.ChechkVlues(temp3);
